...
\begin{frame}[t]{自己紹介}
    \begin{itemize}
        \item tarek（タレク）\onslide<1>{\hphantom{mmmmm}開発@ \raisebox{-0.13cm}{\includegraphics[height=0.5cm]{./img/helpfeel_logo.pdf}}}
...
\begin{frame}[t]{自己紹介}
    \vspace{1cm}
    \begin{figure}
        \begin{center}\includegraphics[height=0.50\textheight]{./img/unarxive_schema.pdf}\end{center}
    \end{figure}
\end{frame}
