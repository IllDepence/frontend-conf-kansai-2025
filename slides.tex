...
\begin{frame}[t]{自己紹介}
    \begin{itemize}
        ...
        \onslide<3->{\item 論文関心
        \begin{itemize}
            \item 前職：研究\onslide<4->{　（学術論文からの情報抽出）}
        \end{itemize}}
    \end{itemize}
\end{frame}

\begin{frame}[t]{自己紹介}
    $\rightarrow$論文の形式や構造に注目した
...
\begin{frame}[t]{学術論文}
    ...
    研究結果を共有 $\rightarrow$　分散（以前印刷、今PDF、ウェブになりかけ）

    研究者（＝個人・出版のプロじゃない人）が書く（最終的な形までのケースがある）、\LaTeX\ やWordから生まれる

    出版社/学会から形式・レイアウトのルールがある
\end{frame}

% \begin{frame}[t]{学術論文}
%     \begin{figure}
%         \begin{overprint}
%             \onslide<1>\begin{center}\includegraphics[height=0.70\textheight]{./img/ja_paper_pdf2web1_onlypdf.png}\end{center}
%             \onslide<2>\begin{center}\includegraphics[height=0.70\textheight]{./img/ja_paper_pdf2web2_onlypdf.png}\end{center}
%             \onslide<3>\begin{center}\includegraphics[height=0.70\textheight]{./img/ja_paper_pdf2web1.png}\end{center}
%             \onslide<4>\begin{center}\includegraphics[height=0.70\textheight]{./img/ja_paper_pdf2web2.png}\end{center}
%         \end{overprint}
%     \end{figure}
% \end{frame}
